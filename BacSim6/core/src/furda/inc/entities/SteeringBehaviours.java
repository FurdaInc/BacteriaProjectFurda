...
public class SteeringBehaviours extends Component implements Steerable<Vector2>, Pool.Poolable {
        ...
        public float vectorToAngle(Vector2 vector) {
            return 0; //return DFUtils.vectorToAngle(vector);
        }
        @Override
        public Vector2 angleToVector(Vector2 outVector, float angle) {
            return null; //DFUtils.angleToVector(outVector, angle);
        }
        @Override
        public Location<Vector2> newLocation() {
            return null; //return new Box2dLocation();
        }
        @Override
